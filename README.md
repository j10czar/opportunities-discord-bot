...
4. **Run Bot Locally**
   To test locally with Docker installed, run:
...
**guilds.json** (Production servers) - _Auto-managed by bot setup_:
...
**test_guilds.json** (Test servers) - _Auto-managed by bot setup_:
...
**keys.json** (Activation keys) - _Managed via SDK_:

```json
["activation_key_1_here", "activation_key_2_here"]
```

**companies.json** (Company logo cache) - _Auto-populated by bot_:
...
- **Jason Tenczar** - Lead Developer
- **Alex Fisher** - Project Manager
- **Steve Sajeev** - Discord Integration
- **Jacob Frankel** - Bot Development
- **Devan Parekth** - Bot Development
- **Tanmay Saxena** - UI Development
- **Mukul Vinoid** - Bot Development
